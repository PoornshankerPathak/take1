...
The data given below contains the information about past loan applicants and whether they ‘defaulted’ or not. The aim is to identify patterns which indicate if a person is likely to default, which may be used for taking actions such as denying the loan, reducing the amount of loan, lending (to risky applicants) at a higher interest rate, etc.
 ...
 Please refer to diagram loan_process_image
...
When a person applies for a loan, there are two types of decisions that could be taken by the company:
    ...
    Since the loan was rejected, there is no transactional history of those applicants with the company and so this data is not 
...
Loan.zip --> contains the complete loan data for all loans issued through the time period 2007 t0 2011.
Data_Dictionary.xlsx --> describes the meaning of variables mentioned in the dataset above. 
